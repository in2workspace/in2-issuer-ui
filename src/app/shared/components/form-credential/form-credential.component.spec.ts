...
//     mockAuthService = jasmine.createSpyObj('AuthService', ['getUserDetails', 'getRoles']);
//
...
//     mockAuthService.getUserDetails.and.returnValue(of(null));
//     mockAuthService.getRoles.and.returnValue(["mandator"]);
